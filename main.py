...
if __name__ == '__main__':
    ...
    # Seoul
    hosSystem.AddAgents([37.54477427445537, 126.9675917719589], 1000, 2, TMAP_CAR)
    hosSystem.AddAgents([37.56492303196376, 126.949014605731], 1000, 2, TMAP_CAR)
    hosSystem.AddAgents([37.55516422740225, 126.97335343369602], 1000, 2, TMAP_CAR)

    # hosSystem.AddAgents([37.54477427445537, 126.9675917719589], 2000, 3, TMAP_CAR)
    # hosSystem.AddAgents([37.56492303196376, 126.949014605731], 2000, 3, TMAP_CAR)
    # hosSystem.AddAgents([37.55516422740225, 126.97335343369602], 2000, 3, TMAP_CAR)
